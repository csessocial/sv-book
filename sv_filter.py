...
EXCLUDE_TITLE_PATTERNS = [
    ...
    # 종교 서적
    r"(하나님|예수|성경|기독교|천주교|가톨릭|성당|교회|목사|신부|선교|복음|묵상|설교|기도|신앙|성령|찬양|천국|구원|은혜|사순절|성탄)",
    r"(불교|부처|석가모니|보살|법화경|반야심경|선불교|참선|수행|절|스님|사찰)",
    r"(이슬람|무슬림|코란|알라|마호메트|힌두교|유대교|시크교)",
]
...
CURATED_TITLES = [
    ...
    "뉴 워", "사회적 자본", "질서의 종말",
    # 엑셀 2026년 선정 도서 전체
    "통합 성장 이론", "통합성장이론", "다극세계가 온다", "휴먼 코드",
    "생각의 진화", "한국은 해킹되었습니다",
    "푸른 행성을 위한 증언", "모두를 위한 우주는 없다",
    "이코노미스트 2026 세계대전망", "직관과 객관",
    "경험의 멸종", "편안함의 습격",
    "AI 시대, 강력한 개인이 온다", "최소불행사회",
    "대한민국 식량의 미래", "인구에서 인간으로",
    "로보 사피엔스 재패니쿠스",
    "지자체장이라면 반드시 알아야 할 세계 60개 도시 이야기",
    "베이비부머 리턴즈", "우리는 무엇을 타고나는가",
    "낯선 사람과 부근을 만들기",
    "뇌는 어떻게 변화를 거부하는가",
    "Innovation hegemony", "혁신패권",
    "이주의 풍경", "쾌적한 사회의 불쾌함",
    "주의! 거짓이 포함되어 있을 수 있음",
    "두 번째 지능", "언보틀드", "어번던스", "벤처노믹스",
    "언어는 어떻게 인간을 바꾸는가",
    "디지털 지도 전쟁", "랜드 파워", "궤도 너머",
    "사회연대경제",
    "비인간", "로봇, 그리고 로봇을 사랑하는 사람들",
    "경험수집가의 시대", "내 집에서 나이 들 수 있을까",
    "아이들이 쉬는 숨",
    "호모 딜리버리쿠스", "퓨처 체인저스",
    "손절사회", "중독을 통제할 수 있다는 착각",
    "극우는 어디서 태어나는가", "뮤지엄 밸류",
]
