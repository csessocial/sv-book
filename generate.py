...
const DIRECTOR_PICKS = [
  ...
  {{title:'이토록 인간적인 능력',author:'그레이엄 리',pub:'더퀘스트',date:'2026.02',bio:'디지털 기술 교육 전문가. 리디언스톤(Lydian Stone) 창립자 겸 CEO. AI 시대에 지켜야 할 인간다움과 핵심 능력을 연구.',desc:'"쓰지 않는 능력은 잃는다" — AI 시대, 우리를 인간답게 만드는 12가지 핵심 능력을 조명하며 인간다움의 본질을 되묻는다.',img:'https://shopping-phinf.pstatic.net/main_5886504/58865048657.20260331112437.jpg',link:'https://search.shopping.naver.com/book/catalog/58865048657'}},
  {{title:'AI 이후의 미래 어떻게 될 것인가',author:'제이슨 솅커',pub:'더페이지',date:'2026.05',bio:'세계적 미래학자. 금융·기술·일자리 전반에 걸친 AI의 파급력을 분석하며 부와 권력의 재편을 전망.',desc:'"AI는 도구가 아니라 새로운 지배 운영체제다" — 세계 산업을 뒤흔드는 AI가 부와 권력을 어디로 향하게 하는지 날카롭게 전망.',img:'https://shopping-phinf.pstatic.net/main_5976274/59762742786.20260428082502.jpg',link:'https://search.shopping.naver.com/book/catalog/59762742786'}},
  {{title:'인간을 인간답게 만드는 불완전함에 대하여',author:'팀 하포드',pub:'윌마',date:'2026.05',bio:'세계적 이코노미스트이자 《경제학 콘서트》 저자. 알고리즘 시대, 인간의 유연함과 창의성이 사회 변혁의 핵심임을 역설.',desc:'알고리즘이 모든 마찰을 제거하는 완벽한 질서의 시대 — 그런데 왜 세상은 더 나아지지 않을까? 불완전함이 인간의 진짜 힘이다.',img:'https://shopping-phinf.pstatic.net/main_5978923/59789235607.20260425072246.jpg',link:'https://search.shopping.naver.com/book/catalog/59789235607'}},
];
